...
import { getProjectTeamMembers, removeMemberFromTeam } from "@/services/TeamService"
    ...
    if (data) return (
        <>
            ...
            <p className="text-2xl font-light text-gray-500 mt-5">
                Manage your team members for this project.
            </p>
            ...
            <nav className="my-5 flex gap-3">
                ...
                <Link
                    ...
                    className="bg-fuchsia-500 hover:bg-fuchsia-700 px-10 py-3 text-white text-xl font-bold cursor-pointer transition-colors"
                >
            ...
            {data.length ? (
                ...
                <p className='text-center py-20'>There's not members on this project yet.</p>
            )}
