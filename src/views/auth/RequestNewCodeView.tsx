...
import { postRequestCode } from "@/services/AuthService";
...
export default function RequestNewCodeView() {
    ...
    return (
        <>
            <h1 className="text-5xl font-black text-white">Request for new validation code</h1>
            <p className="text-2xl font-light text-white mt-5">
                Writte your email to generate {''}
